...
public class CommentController {
    ...
    @ManagerOrUser
    @Operation(summary = "API 명세서 v0.3 line 51", description = "티켓에 텍스트 타입 댓글 작성")
    ...
    @Operation(summary = "API 명세서 v0.3 line 53", description = "티켓의 로그와 댓글 전체 조회")
    ...
    @ManagerOrUser
    @Operation(summary = "API 명세서 v0.3 line 54", description = "특정 댓글에 좋아요 토글")
    ...
    @Operation(summary = "API 명세서 v0.3 line 55", description = "특정 댓글에 좋아요 누른 멤버 조회")
    ...
    @ManagerOrUser
    @Operation(summary = "API 명세서 v0.3 line 52", description = "티켓 댓글에 파일 첨부")
