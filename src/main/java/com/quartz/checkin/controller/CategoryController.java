...
public class CategoryController {
    ...
    @Operation(summary = "API 명세서 v0.3 line 57", description = "전체 카테고리 조회")
    @GetMapping
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 58", description = "관리자가 1차 카테고리 작성")
    @PostMapping
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 59", description = "관리자가 1차 카테고리 수정")
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 60", description = "관리자가 1차 카테고리 삭제")
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 61", description = "관리자가 2차 카테고리 작성")
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 62", description = "관리자가 2차 카테고리 수정")
    ...
    @Admin
    @Operation(summary = "API 명세서 v0.3 line 63", description = "관리자가 2차 카테고리 삭제")
